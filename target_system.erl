%%% version 5.6.5
%%% we do some changes: add the arguments to make_script and make_tar
...
create(RelFileName) ->
    ...
    create(RelFileName, [], [{erts, RootDir}]).
create(RelFileName, ScriptOpts, TarOpts) when is_list(ScriptOpts), is_list(TarOpts) ->
